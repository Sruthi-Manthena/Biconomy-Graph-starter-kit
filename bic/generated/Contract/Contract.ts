...
export class Contract__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class Contract extends ethereum.SmartContract {
  ...
  checkpoints(param0: Address, param1: BigInt): Contract__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new Contract__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<Contract__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint96)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new Contract__checkpointsResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  minimumTimeBetweenMints(): BigInt {
    let result = super.call(
      ...
      "minimumTimeBetweenMints():(uint32)",
      []
    );
  ...
  mintCap(): i32 {
    let result = super.call("mintCap", "mintCap():(uint8)", []);

    return result[0].toI32();
  }

  try_mintCap(): ethereum.CallResult<i32> {
    let result = super.tryCall("mintCap", "mintCap():(uint8)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
